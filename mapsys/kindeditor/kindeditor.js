...
KE.setting = {
	...
	items : [
		...
		'flash', 'media', 'accessory', 'advtable', 'hr', 'emoticons', 'link', 'unlink', '|', 'about'
	],
	colorTable : [
...
KE.util = {
	...
	getFullHtml : function(id) {
		...
		html += '<link href="' + KE.g[id].skinsPath + 'common/editor.css?v=111027&ver=' + escape(KE.version) + '" rel="stylesheet" type="text/css" />';
		...
		html += '</head>';
		html += '<body class="ke-content" id="text_count"></body>';
		html += '</html>';
		return html;
	},
...
KE.plugin['accessory'] = {
    ...
    check: function (id) {
        ...
        if (url.match(/\.(rar|zip|pdf|doc|xls|mp3)$/i) == null) {
