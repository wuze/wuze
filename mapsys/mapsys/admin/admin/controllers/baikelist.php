 ...
 *
 */
class Baikelist extends MY_Controller {
	...
	{	
		...
		$data['list'] = $list;
		$data['pagetitle'] = "百科列表";
		$this->load->view('baike_list',$data);
	}
	
	
	public function baike_edit(){
		...
		$data['notice'] =  $notice;
		$data['pagetitle'] = "编辑文章";
		$this->load->view('baike_edit',$data);
	}
