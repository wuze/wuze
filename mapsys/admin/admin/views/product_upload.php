...
<div id="content">
    ...
    <div id="right">
		...
		<div style="border: 1px solid #C4D5DF; margin: 0 auto 10px; padding: 10px;overflow:hidden;zoom:1px;">
			...
			<caption class="capcenter">上传产品图片</caption>
			<tr>
				<th>图片：</th>
				<td>
					<form action="<?php echo site_url('/product/upload/');?>" id="image_upload" name="image_upload" method="post" accept-charset="utf-8" enctype="multipart/form-data">
			...
			<tr>
				...
				<td><div id="avatar-preview" name="avatar-preview">
					<img width="163" height="162" src="<?php echo $upload_file;?>">				
				</div></td>
			</tr>
			</table>
		</div>
