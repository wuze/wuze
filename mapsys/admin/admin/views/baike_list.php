...
<div id="content">
    ...
    <div id="right">
    	...
    	<tbody>
			<tr>
				<th class="h_60" width="150">文章ID</th>
				<th class="h_60" width="150">文章标题</th>
				<th class="h_60" width="150">文章类型</th>
				<th class="h_60" width="150">文章作者</th>
    	...
    	<?php if($list){?>
    		...
    		<?php endforeach;?>
		<?php }else{?>
		<tr><td colspan="9" style="text-align:center;">没有内容，<a href="<?php echo site_url('baikelist/baike_edit');?>">去编辑</a></td></tr>
		<?php }?>
		</tbody>
		</table>
		</div>
