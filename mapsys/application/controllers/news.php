...
class News extends CI_Controller {
	...
	{
		$page_config['url']='/news/showlist';//url
		...
		$sql = " SELECT COUNT(1) as cnt FROM ddnews WHERE type='news' ".
